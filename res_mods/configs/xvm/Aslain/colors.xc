{
  ...
  "colors": {
    ...
    "kb": [
      ...
      { "value": 6,   "color": ${"def.colorRating.bad"      } },   //  2 - 4
      { "value": 16,   "color": ${"def.colorRating.normal"   } },   //  5 - 8
      { "value": 30,  "color": ${"def.colorRating.good"     } },   //  9 - 13
      { "value": 43,  "color": ${"def.colorRating.very_good"} },   // 14 - 19
