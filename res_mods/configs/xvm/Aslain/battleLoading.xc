{
  "battleLoading": {
    ...
    "clockFormat": "H:i:s",
    "formatLeftNick": "<img src='xvm://res/icons/flags/{{flag|default}}.png' width='16' height='13'> <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user|none}}.png'> <font color='{{c:r}}' size='12' alpha='{{alive?#FF|#80}}'>{{nick%.14s~..}}</font>",
    ...
    "formatRightNick": "<font color='{{c:r}}' size='12' alpha='{{alive?#FF|#80}}'>{{nick%.14s~..}}</font> <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user|none}}.png'> <img src='xvm://res/icons/flags/{{flag|default}}.png' width='16' height='13'>",
