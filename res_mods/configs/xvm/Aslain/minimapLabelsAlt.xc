{
    "labels": {
      ...
      "units": {
        ...
        "format": {
          "ally":  "<font face='$FieldFont' size='7' color='{{c:r|#C8FFA6}}'>{{r}}</font>",
          "teamkiller":  "<font face='$FieldFont' size='7' color='{{c:r|#A6F8FF}}'>{{r}}</font>",
          "enemy": "<font face='$FieldFont' size='7' color='{{c:r|#FCA9A4}}'>{{r}}</font>",
          "squad": "<font face='$FieldFont' size='7' color='{{c:r|#FFD099}}'>{{r}}</font>",
          "oneself": "",
          "lostally":  "<textformat leading='-3'><span class='mm_dot'>{{vehicle-class}}</span>\n<span class='mm_la'> <i><font face='$FieldFont' size='7' color='{{c:r|#C8FFA6}}'>{{r}}</font></i></span><textformat>",
          "lostteamkiller":  "<textformat leading='-3'><span class='mm_dot'>{{vehicle-class}}</span>\n<span class='mm_lt'> <i><font face='$FieldFont' size='7' color='{{c:r|#A6F8FF}}'>{{r}}</font></i></span><textformat>",
          "lost":  "<textformat leading='-3'><span class='mm_dot'>{{vehicle-class}}</span>\n<span class='mm_l'>   <i><font face='$FieldFont' size='7' color='{{c:r|#FCA9A4}}'>{{r}}</font></i></span><textformat>",
          "lostsquad":  "<textformat leading='-3'><span class='mm_dot'>{{vehicle-class}}</span><span class='mm_ls'>  <i><font face='$FieldFont' size='7' color='{{c:r|#FFD099}}'>{{r}}</font></i></span><textformat>",
